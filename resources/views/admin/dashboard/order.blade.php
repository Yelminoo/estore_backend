...
@section('title', 'Dashboard Pending Order list page')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Pending Order lists</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Pending Order lists</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <div class="input-group input-group-sm" style="width: 150px;">
                                    ...
                                    {{-- <form action="{{ route('dashboard#orderPage') }}" method="get"
                                        class=" d-flex ">
                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $o->id }}</td>
                                        <td>{{ $o->user_name }}</td>
                                        <td><a href="{{ route('dashboard#pendingOrderDetailsPage',$o->order_code) }}">{{
                                                $o->order_code
                                                }}</a></td>
                                        <td>{{ $o->total_price }}</td>
                                        <td>
